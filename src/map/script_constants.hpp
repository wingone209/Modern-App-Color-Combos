...
#define SCRIPT_CONSTANTS_HPP
	...
	export_deprecated_constant2("SI_CHASING", 1560);
	export_deprecated_constant2("SI_MYSTERY_POWDER", 1665);
	export_deprecated_constant2("SI_WILD_WALK", 1666);
	export_deprecated_constant2("SI_FIRE_CHARM_POWER", 1667);
	export_deprecated_constant2("SI_WATER_CHARM_POWER", 1668);
	export_deprecated_constant2("SI_WIND_CHARM_POWER", 1669);
	export_deprecated_constant2("SI_GROUND_CHARM_POWER", 1670);
	export_deprecated_constant2("SI_OVERCOMING_CRISIS", 1671);
