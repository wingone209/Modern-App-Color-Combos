...
{// clif_skill_fail
	...
	USESKILL_FAIL_REQUIRE_SERVANT_WEAPON,
	USESKILL_FAIL_TWINKLING_GALAXY, // Not in the Twinkling Galaxy area for SKE_STAR_CANNON MSI_USESKILL_FAIL_TWINKLING_GALAXY MSI(3957)
	USESKILL_FAIL_SOUL_ACCUMULATION, // MSI_USESKILL_FAIL_SOUL_ACCUMULATION MSI(3958)
	USESKILL_FAIL_AMULETS_NEEDED, // MSI_USESKILL_FAIL_AMULETS_NEEDED MSI(3959)
	USESKILL_FAIL_NEED_EQUIPPED_GUN_GATLING_OR_SHOTGUN, // MSI_USESKILL_FAIL_NEED_EQUIPPED_GUN_GATLING_OR_SHOTGUN MSI(3960)
	USESKILL_FAIL_NEED_EQUIPPED_RIFLE_OR_REVOLVER, // MSI_USESKILL_FAIL_NEED_EQUIPPED_RIFLE_OR_REVOLVER MSI(3961)
	USESKILL_FAIL_NEED_EQUIPPED_GRENADE_LAUNCHER_OR_RIFLE, // MSI_USESKILL_FAIL_NEED_EQUIPPED_GRENADE_LAUNCHER_OR_RIFLE MSI(3962)
	USESKILL_FAIL_NEED_EQUIPPED_GATLING_GUN_OR_REVOLVER, // MSI_USESKILL_FAIL_NEED_EQUIPPED_GATLING_GUN_OR_REVOLVER MSI(3963)
	USESKILL_FAIL_NEED_EQUIPPED_SHOTGUN_OR_GRENADE_LAUNCHER, // MSI_USESKILL_FAIL_NEED_EQUIPPED_SHOTGUN_OR_GRENADE_LAUNCHER MSI(3964)
	USESKILL_FAIL_NEED_EQUIPPED_SHIELD, // MSI_USESKILL_FAIL_NEED_EQUIPPED_SHIELD MSI(3965)
	USESKILL_FAIL_SS_SHIMIRU, // No space behind the target to use SS_SHIMIRU MSI(3968)
	USESKILL_FAIL_MAX
};
